...
static_region_t gen_test_static_config(){
    ...
    static_region.grid_mux_sel[0][0][0] = IO_UNIT_GRID_MUX_ADDR;
    for(int i = 1; i < NUM_GRID_ROWS; i++){
        static_region.grid_mux_sel[0][i][0] = 1;
    }
    ...
    static_region.io_mux_sel[1] = 5;

    // static_region.io_mux_sel[2] = 6;
    // static_region.io_mux_sel[3] = 6;

    static_region.result_mux_sel_nfb[1][0] = UNUSED_WRITE_PORT_ADDR;
    ...
    static_region.result_mux_sel_fb[1][0] = UNUSED_WRITE_PORT_ADDR;
    ...
    static_region.ls_mask_fb[RCA_B][1] = true;
...
int main(void) {
    ...
    asm volatile("li x6, 0x80000004; li x7, 0x80000004"
        :
        :
        :"x6", "x7"
